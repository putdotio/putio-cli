...
The CLI does not accept put.io account credentials. Its login flow delegates authorization to the official web app and stores only the returned OAuth token.
