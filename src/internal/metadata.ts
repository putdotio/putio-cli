...
const CliMetadataSchema = Schema.Struct({
  ...
  auth: Schema.Struct({
    ...
    loginCredentialEnv: Schema.Struct({
      clientId: NonEmptyStringSchema,
      clientSecret: NonEmptyStringSchema,
      password: NonEmptyStringSchema,
      totpSecret: NonEmptyStringSchema,
...
export const describeCli = (
  ...
  decodeCliMetadata({
    ...
    auth: {
      ...
      loginCredentialEnv: {
        clientId: ENV_CLI_LOGIN_CLIENT_ID,
        clientSecret: ENV_CLI_LOGIN_CLIENT_SECRET,
        password: ENV_CLI_LOGIN_PASSWORD,
        totpSecret: ENV_CLI_LOGIN_TOTP_SECRET,
        username: ENV_CLI_LOGIN_USERNAME,
      },
