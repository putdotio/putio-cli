...
- Classify structured failures using optional `error.httpStatusCode`, `error.statusCode`, and `error.errorType`, never localized prose; see [guardrails](references/guardrails.md).
